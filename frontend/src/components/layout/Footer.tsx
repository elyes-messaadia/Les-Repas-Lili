        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/restaurants" className="text-gray-400 hover:text-white text-sm">
                  Restaurants
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/confidentialite" className="text-gray-400 hover:text-white text-sm">
                  Confidentialité
                </Link>
              </li>
              <li>
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-2">
              <div className="flex max-w-md">
                ...
                <input
                  ...
                  className="flex-1 min-w-0 px-3 py-2 text-sm text-gray-900 placeholder-gray-500 border border-transparent rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Votre email"
                />
                <button
                  type="submit"
                  className="flex-shrink-0 px-4 py-2 text-sm font-medium text-white bg-blue-500 border border-transparent rounded-r-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  OK
                </button>
              </div>
